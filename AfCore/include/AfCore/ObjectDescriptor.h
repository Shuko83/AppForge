...
namespace appforge::core {
     ...
     * (pluginId + componentId), son affichage, sa version, sa catégorie et des tags}
     * libres. Elle fournit également des utilitaires de sérialisation JSON et des
    ...
    public:
         ...
         */
        QString id() const;
        void setId(const QString& componentId);
         ...
         */
        QMap<QString, QString> errors() const;
