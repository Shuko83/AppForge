...
ComponentDescriptor::ComponentDescriptor(QString pluginId, QString componentId, QString displayName)
...
QString ComponentDescriptor::pluginId() const
{
    return _pluginId;
}

void ComponentDescriptor::setPluginId(const QString& pluginId)
{
...
QString ComponentDescriptor::componentId() const
{
    return _componentId;
}

void ComponentDescriptor::setComponentId(const QString& componentId) 
{
...
QString ComponentDescriptor::fullId() const
{
